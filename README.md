...
## 🚀 Getting Started with ghsa-skill-builder
...
- Look for a file ending with `.exe` (for example, `ghsa-skill-builder-setup.exe`).
...
## ⚙️ How ghsa-skill-builder Works Behind the Scenes
